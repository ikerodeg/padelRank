const JUGADORES_ARR = [
  ...
  {name: 'Alfredo Sanchez', level_init: 3.00, pg: 0, pp: 1, level_act: ''},
  ...
  {name: 'Andres Lopez Amores', level_init: 3.25, pg: 1, pp: 4, level_act: ''},
  ...
  {name: 'Borja Gonzalez', level_init: 3.25, pg: 3, pp: 4, level_act: ''},
  ...
  {name: 'Constan Sales', level_init: 3.50, pg: 6, pp: 1, level_act: ''},
  ...
  {name: 'David Blasco', level_init: 3.25, pg: 0, pp: 0, level_act: ''},
  ...
  {name: 'Eduard Moliner Peraire', level_init: 3.50, pg: 0, pp: 1, level_act: ''},
  {name: 'Elisabeth Breva', level_init: 2.25, pg: 0, pp: 0, level_act: ''},
  {name: 'Ege Urel', level_init: 2.50, pg: 1, pp: 0, level_act: ''},
  {name: 'Enrique Esteban', level_init: 3.25, pg: 4, pp: 3, level_act: ''},
  {name: 'Erwin Bir', level_init: 3.00, pg: 0, pp: 2, level_act: ''},
  {name: 'Felipe Diaz', level_init: 3.00, pg: 0, pp: 1, level_act: ''},
  ...
  {name: 'Gabriel Vilar', level_init: 3.25, pg: 4, pp: 1, level_act: ''},
  ...
  {name: 'Hector Vicente Sales', level_init: 3.00, pg: 3, pp: 1, level_act: ''},
  {name: 'Hernan Mahfuz', level_init: 2.75, pg: 2, pp: 1, level_act: ''},
  ...
  {name: 'Isaac Torres Sanchez', level_init: 3.00, pg: 0, pp: 0, level_act: ''},
  {name: 'Iker Rodriguez', level_init: 3.00, pg: 10, pp: 1, level_act: ''},
  ...
  {name: 'Javier Jimenez Espinosa', level_init: 3.00, pg: 1, pp: 4, level_act: ''},
  ...
  {name: 'Jose M. Gomez', level_init: 3.00, pg: 1, pp: 2, level_act: ''},
  ...
  {name: 'Juan L. Echaniz', level_init: 4.00, pg: 0, pp: 0, level_act: ''},
  {name: 'Joan Simón Bueno', level_init: 3.25, pg: 2, pp: 2, level_act: ''},
  {name: 'Julio Villuendas', level_init: 3.75, pg: 0, pp: 1, level_act: ''},
  {name: 'Lucas Castell', level_init: 3.75, pg: 0, pp: 0, level_act: ''},
  {name: 'Luis Contreras', level_init: 2.75, pg: 2, pp: 1, level_act: ''},
  ...
  {name: 'Marina Andión', level_init: 2.75, pg: 0, pp: 2, level_act: ''},
  ...
  {name: 'Pedro Felip', level_init: 3.25, pg: 4, pp: 1, level_act: ''},
  ...
  {name: 'Ricardo Gutierrez', level_init: 2.50, pg: 0, pp: 0, level_act: ''},
  {name: 'Roberto Portolés', level_init: 3.75, pg: 1, pp: 0, level_act: ''},
  {name: 'Salvador Úbeda', level_init: 3.00, pg: 4, pp: 0, level_act: ''},
  {name: 'Santiago Quintana', level_init: 3.50, pg: 0, pp: 0, level_act: ''},
  ...
  {name: 'Sergio Fores', level_init: 2.50, pg: 0, pp: 0, level_act: ''},
  ...
  {name: 'Tomas Marco Soriano', level_init: 2.75, pg: 1, pp: 0, level_act: ''},
  {name: 'Tomás Moreno', level_init: 3.50, pg: 0, pp: 4, level_act: ''},
  {name: 'Toni Valderrama', level_init: 3.50, pg: 1, pp: 8, level_act: ''},
  ...
  {name: 'Victor Pascual', level_init: 2.75, pg: 1, pp: 0, level_act: ''},
