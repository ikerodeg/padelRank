const JUGADORES_ARR = [
  ...
  {name: 'César Ortuño', level_init: 3.50, pg: 4, pp: 1, level_act: ''},
  ...
  {name: 'Jose Carlos Ballester', level_init: 3.50, pg: 1, pp: 1, level_act: ''},
  {name: 'Jose Ignacio Muñoz', level_init: 2.75, pg: 1, pp: 0, level_act: ''},
  {name: 'Jose Luis Micola', level_init: 2.75, pg: 0, pp: 2, level_act: ''},
  ...
  {name: 'Miguel Gonzalez', level_init: 3.25, pg: 0, pp: 0, level_act: ''},
  ...
  {name: 'Tomás Valderrama', level_init: 3.50, pg: 1, pp: 6, level_act: ''},
  {name: 'Toni Villena', level_init: 2.75, pg: 1, pp: 1, level_act: ''},
  {name: 'Vicente Ribes', level_init: 3.25, pg: 2, pp: 4, level_act: ''},
  {name: 'Vicente Oms', level_init: 3.00, pg: 0, pp: 2, level_act: ''},
