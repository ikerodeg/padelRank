const JUGADORES_ARR = [
  ...
  {name: 'Albert Esteve Breteain', level_init: 3.75, pg: 1, pp: 0, level_act: ''},
  ...
  {name: 'Enrique Esteban', level_init: 3.25, pg: 3, pp: 3, level_act: ''},
  ...
  {name: 'Hector Vicente Sales', level_init: 3.00, pg: 3, pp: 2, level_act: ''},
  ...
  {name: 'Javier Isidro Breva', level_init: 3.25, pg: 1, pp: 0, level_act: ''},
  {name: 'Javier Ferrer', level_init: 2.75, pg: 3, pp: 1, level_act: ''},
  {name: 'Javier Jimenez Espinosa', level_init: 3.00, pg: 1, pp: 5, level_act: ''},
  {name: 'Javier Jimenez Jimenez', level_init: 3.00, pg: 0, pp: 0, level_act: ''},
  ...
  {name: 'Pedro Felip', level_init: 3.25, pg: 3, pp: 1, level_act: ''},
  ...
  {name: 'Victor Pascual', level_init: 2.75, pg: 1, pp: 1, level_act: ''},
